...
INSERT INTO `CDL` (`DefID`, `OldID`, `Location`, `SpecLoc`, `Severity`, `Description`, `Spec`, `DateCreated`, `Status`, `IdentifiedBy`, `SystemAffected`, `GroupToResolve`, `ActionOwner`, `EvidenceType`, `EvidenceLink`, `DateClosed`, `LastUpdated`, `Comments`, `updatedBy`, `Created_by`, `SafetyCert`, `RequiredBy`, `DueDate`, `ClosureComments`, `Pics`, `Repo`) VALUES
...
INSERT INTO `EvidenceType` (`EviTypeID`, `EviType`, `lastUpdated`, `updatedBy`) VALUES
...
INSERT INTO `Location` (`LocationID`, `LocationName`, `lastUpdated`, `updatedBy`) VALUES
...
INSERT INTO `Severity` (`SeverityID`, `SeverityName`, `Description`, `lastUpdated`, `updatedBy`, `Prority`) VALUES
...
INSERT INTO `Status` (`StatusID`, `Status`, `lastUpdated`, `updatedBy`) VALUES
...
INSERT INTO `System` (`SystemID`, `System`, `lastUpdated`, `updatedBy`, `Lead`) VALUES
...
INSERT INTO `users_enc` (`UserID`, `Username`, `Role`, `Password`, `firstname`, `lastname`, `LastUpdated`, `updatedBy`, `DateAdded`, `Created_by`, `Email`, `secQ`, `secA`, `LastLogin`, `Company`, `viewIDR`) VALUES
